...
input_image = r"E:\Handwitten2Text\image-5.png"
...
def show_webcam(mirror=False):
    ...
    json_file = open(r'E:\Handwitten2Text\model.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    model = model_from_json(loaded_model_json)
    # load weights into new model
    model.load_weights(r"E:\Handwitten2Text\model_weights.h5")
    ...
    while True:
        ...
        cv2.imshow("checking thresh", thresh)
        ans = ''
        ...
        cv2.putText(img, "Predicted Number : " + str(ans), (10, 320),
